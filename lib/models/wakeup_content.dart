...
class ContentData {
  static WakeupContent get englishContent => WakeupContent(
        ...
        morningGreetings: [
          'Hello, {name}! Today holds wonderful surprises just for you!',
          ...
          'Hello, {name}! Your dreams are calling - time to answer!',
          'Hey there, {name}! Today is your day to shine brilliantly!',
          'Hello, {name}! Let\'s make today better than yesterday!',
          'Wake up, sunshine {name}! The world needs your special magic today!',
          'Hello, {name}! Today is full of endless possibilities!',
          ...
          'Hello, {name}! Let your positive energy light up the world!',
        ],
      );
