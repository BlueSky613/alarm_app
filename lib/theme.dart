...
class LightModeColors {
  static const lightPrimary = Color(0xFF6B46C1); // Dawn purple
  static const lightOnPrimary = Color(0xFFFFFFFF);
  static const lightPrimaryContainer = Color(0xFFF3E8FF); // Light lavender
  static const lightOnPrimaryContainer = Color(0xFF2D1B69);
  static const lightSecondary = Color(0xFFEC8E52); // Sunrise orange
  static const lightOnSecondary = Color(0xFFFFFFFF);
  static const lightTertiary = Color(0xFFDB2777); // Morning pink
  ...
  static const lightAppBarBackground = Color(0xFFF3E8FF);
}

class DarkModeColors {
  static const darkPrimary = Color(0xFFBB86FC); // Light purple
  static const darkOnPrimary = Color(0xFF2D1B69);
  static const darkPrimaryContainer = Color(0xFF5B21B6); // Deep purple
  static const darkOnPrimaryContainer = Color(0xFFF3E8FF);
  static const darkSecondary = Color(0xFFFFAB70); // Light orange
  static const darkOnSecondary = Color(0xFF7C2D12);
  static const darkTertiary = Color(0xFFF472B6); // Light pink
  ...
  static const darkSurface = Color(0xFF0F0F23); // Deep night blue
